    ...
    <div className="space-y-3">
      ...
      <div className="flex">
        ...
        <div className="w-[240px] shrink-0">
          <div className="bg-white border-y border-slate-200 px-3 h-12 flex items-center font-semibold text-slate-700 tracking-wide">
            Properties
          </div>
        ...
        <div className="w-[200px] shrink-0 border-l border-slate-200">
          <div className="bg-white border-y border-slate-200 px-3 h-12 flex items-center text-xs font-semibold text-slate-700 tracking-wide">
            Costs
          </div>
          {displayProperties.map((prop) => {
